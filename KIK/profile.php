...
<body>
    <div class="app-container" style="padding-bottom: 50px; min-height: 100vh;">
        ...
        <div id="mainProfileMenu" style="padding: 0 20px;">
            ...
            <div class="menu-item" onclick="openSubPage('editProfilePage', 'Edit Profile')"><span>Edit Profile</span> <span style="color:#ccc;">›</span></div>

            <div class="menu-item" id="verifMenu" onclick="openSubPage('verifPage', 'Verifikasi 2 Langkah')">
                <span>Verifikasi 2 Langkah</span>
                <span id="verifArrow" style="color:#ccc;">›</span>
            </div>
        ...
        <div style="padding: 0 20px;">
            ...
            <div id="editProfilePage" class="sub-page">
                <div style="text-align: center; margin-bottom: 25px;">
                    ...
                    <div style="display: flex; justify-content: center; gap: 10px;">
                        ...
                        <button class="btn-camera-trigger" onclick="document.getElementById('galleryInput').click()">📁 Galeri</button>
                    </div>
                </div>
            ...
            <div id="termsPage" class="sub-page">
                <p style="padding:20px; font-size:12px;">Terms of Use...</p>
            </div>
            <div id="privacyPage" class="sub-page">
                <p style="padding:20px; font-size:12px;">Privacy Policy...</p>
            </div>
        </div>
    </div>
    ...
    <div id="bugModal" class="modal-overlay">
        <div class="modal-box"><span class="modal-icon">✉️</span>
    ...
    <script>
        ...
        // --- FIXED: Template Gmail (RESTORED TO ORIGINAL FULL VERSION) ---
